...
//        user.setRoles(roles);
//
//        TokenPrincipalDto tokenPrincipalDto = new TokenPrincipalDto(id, email);
//
//        List<GrantedAuthority> authorities = authorityUtils.createAuthorities(roles);
//        Authentication authentication = new UsernamePasswordAuthenticationToken(tokenPrincipalDto, null, authorities);
//        SecurityContextHolder.getContext().setAuthentication(authentication);
//    }
//}
