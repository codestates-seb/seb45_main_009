...
//                                   @RequestPart("photo-url") List<MultipartFile> photoFiles,
                                   @Valid @RequestPart FeedDto.PostDto feedPostDto) {

        // 회원 검증 필요

        Feed feed = feedService.createFeed(feedMapper.feedPostDtoToFeed(feedPostDto), photoFile);
...
//                                    @RequestPart("photo-url") List<MultipartFile> photoFiles,
        ...
        Feed feed = feedService.updateFeed(feedMapper.feedPatchDtoToFeed(feedPatchDto), photoFile);
