  ...
  return(
    ...
    <div className="mt-20">
      <div className="grid grid-cols-6 gap-4 items-center">
        <img src='/asset/img.png'  className='w-8 h-8 rounded-full col-span-1' />
        <input 
        ...
        <div key={index} className="mt-10">
          <div className="grid grid-cols-6 gap-4 items-center mb-2">
            ...
            <div className="col-span-2 flex justify-end gap-2">
              ...
              <button className="text-gray-400 text-sm" onClick={() => handleDeleteComment(index)}>삭제</button>
            </div>
          </div>
          {
                iscomment === false ? 
                  ...
                  <div className="grid grid-cols-5 gap-4 items-center ml-10">
                    <input className="border rounded col-span-3" type="text" placeholder={item} onChange={handleCommentChange}/>
                    <button className="text-gray-400 text-sm col-span-2" onClick={() => handleUpdateComment(index)}>저장</button>
                  </div>
          }
          <div className="grid grid-cols-6 gap-4 items-center">
              <div className="w-8 h-8 rounded-full col-span-1"></div>
              <div className="col-span-3 text-gray-400 text-sm">{commentdate[index]} {currentTime[index]}</div>
              <div className="col-span-2 flex justify-end gap-2"></div>
          </div> 
        </div>
      ))
