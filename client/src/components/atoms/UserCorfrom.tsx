...
const UserCorForm: React.FC<Props> = ({ handleInputChange }) => {
  return (
    <>
      ...
      <CommonInput placeholder="전화번호" type="text" onChange={(e) => handleInputChange(e, "selfintroduction")} />
      <CommonInput placeholder="소개" type="text" onChange={(e) => handleInputChange(e, "phonenumber")} />
      <CommonInput placeholder="가격/정보" type="text" onChange={(e) => handleInputChange(e, "price")} />
    </>
  );
};
