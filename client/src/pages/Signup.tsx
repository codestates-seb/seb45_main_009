  ...
  return (
    < div className=" flex justify-center pt-[20px] mb-[40px]">
        <div className="w-[300px]">
            ...
            {isValidEmail === null ? (null) : isValidEmail ? null : (<p className='text-[12px] text-isValid-text-red'>유효하지 않은 이메일 형식입니다.</p>)}
            ...
            {isValidPw === null ? (null) : isValidPw ? null : (<p className='text-[12px] text-isValid-text-red'>비밀번호 형식을 확인해주세요.</p>)}
            ...
            <div className='flex justify-center mt-[20px]'>
                <input id="남자" value="남자" name="gender" type="radio"/>남자
                <input className='ml-[10px]' id="여자" value="여자" name="gender" type="radio"/>여자
            </div>

            <button type="submit" onClick={onSubmitHandler} className="w-[300px] h-[30px] rounded-[4px] text-[14px] mt-[20px] font-medium bg-btn-color text-white">회원가입</button>
        </div>
    </ div>
  );
}
