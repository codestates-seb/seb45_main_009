  ...
  return (
    < div className=" flex justify-center pt-[20px] mb-[40px]">
        <div className="w-[300px]">
            ...
            <button type="submit" onClick={onSubmitHandler} className="w-[300px] h-[30px] rounded-[4px] text-[14px] mt-[20px] font-medium bg-btn-color text-white">로그인</button>

            <div className="text-[12px] w-full mt-[10px] flex justify-center  font-medium text-gray-400 mb-[10px]">회원가입</div>
