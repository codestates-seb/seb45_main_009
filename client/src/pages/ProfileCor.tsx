...
const Modal = ({ onClose }: any) => {
  ...
  return (
    <div
      ref={modalRef}
      className="flex flex-col border rounded-[4px] w-[100px] 
      absolute  md:right-[60px] right-[100px] md:top-[200px] top-[280px] "
    >
      <button onClick={onClose} className="border-b">
        삭제
      </button>
      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-4 lg:px-8 mt-[100px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          ...
          <div className="md:hidden flex items-center space-x-4">
            <button
              className="w-[100px] h-[30px] rounded-[4px] text-[14px] font-medium bg-btn-color text-white"
              onClick={followClick}
            >
              {isFollowing ? "팔로잉" : "팔로우"}
            </button>
          ...
          <div className="hidden md:flex items-center justify-end md:justify-start">
            <button
              className="ml-[200px] mr-4 w-[100px] h-[30px] rounded-[4px] text-[14px] font-medium bg-btn-color text-white"
              onClick={followClick}
            >
              {isFollowing ? "팔로잉" : "팔로우"}
            </button>
          ...
          <div className="mt-[20px]">
            ...
            <div className="items-center space-x-2">
              ...
              <div>
                {userData[0].price.map((price, index) => (
