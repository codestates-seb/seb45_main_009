...
//             </ul>
//           </div>
//           <div className="border-b border-bdc rounded px-3 pt-2 mh-[50px] text-btc ">
//             <ul>
...
//             </ul>
//           </div>
//           <span className="text-[12px] ml-2 mb-20 ">최대 5개까지 추가됩니다.</span>
//         </div>
//         <button
//           onClick={submitForm}
          ...
          <div className="border-b border-bdc rounded pr-3 pt-2 mh-[50px] text-btc">
            <ul>
              {addedTags.map((tag, index) => (
                ...
                >
                  <span className="text-[14px]  font-medium mr-2 inline-block text-[#22a1ff]">{`#${tag}`}</span>
                  <TiDelete
